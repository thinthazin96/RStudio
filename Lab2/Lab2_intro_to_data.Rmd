...
nycflights %>%
  ...
  arrange((median_dd))
```
October is a month that minimizes your potential departure delay leaving NYC using lowest mean departure delay but using lowest median departure delay, September is a month that minimizes your potential departure delay leaving NYC.The graph is positive skewed distribution.
